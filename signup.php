        ...
        if(!empty($user_id) && !empty($password))
        {
            if (preg_match($pattern, $email) === 1) 
            {
                if (strlen($password) >= 5 && strlen($password) <= 8){ 
                    ...
                    //save to database
                    $query = "INSERT INTO users(doc_id, fullname, email, designation, DOB, address, phone, password, gender) 
                    VALUES ('$user_id','$fullname','$email','$designation','$dateofbirth','$address','$phone','$hash','$gender')";
        ...
        <div id="signup_window" class="signup_window">
            ...
            <form  method="POST">
                <div class="fill_box">
                    ...
                    <input type="text" name="user_id" placeholder="5 Digit User ID" required>
                </div>
                <div class="fill_box">
